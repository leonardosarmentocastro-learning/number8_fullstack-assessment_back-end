...
import { VALID_DEPARTMENT_1, VALID_DEPARTMENT_2 } from '../modules/departments/__tests__/__fixtures__/departments.fixtures.js';
...
export const seedDepartments = async () => {
  ...
  return { createdDepartment1, createdDepartment2 };
};
